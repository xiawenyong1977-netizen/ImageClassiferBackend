...
flowchart TB
    ...
    subgraph L2["第二层：WEB服务"]
        direction TB
      
        subgraph WebLayer["WEB容器[阿里云-华东]"]
            Lighttpd[Lighttpd]
        ...
        subgraph CDNLayer["CDN（青牛）<br/>m.xintuxiangce.top"]
            AppDownload[APP下载]
        end
    ...
    subgraph L3["第三层：APP服务（阿里云-华东）"]
        ...
        subgraph Services["照片处理"]
            ...
            subgraph BaseServices["基础服务"]
                ...
                LocalReference[本地推理<br/>LocalReference]
    ...
    %% 第一层到第二层再到第三层的访问
    Wechat -->|m.xintuxiangce.net| CDNLayer
    ...
    class CDN,AppDownload,Lighttpd,Site1,Site2,Site3,DBSlave layer2
